...
else if(isset($_POST['all']))
{
    $sql="SELECT * FROM ((`bookings`
INNER JOIN trip_details  ON bookings.unique_tripID=trip_details.Unique_tripID) 
INNER JOIN stu_details ON bookings.user_uniqueID=stu_details.unique_id)  where trip_details.Date >= CURDATE() and bookings.unique_tripID=:uti and email_id=:eid";
